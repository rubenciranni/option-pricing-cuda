...
inline constexpr Hyperparams DEFAULT_HYPERPARAMS_CUDA_BKDSTPRCMP_XOVLPUNROLL_SHUFFLE(256, 50, -1);
...
// #define DO_CARTESIAN_PRODUCT_OF_VANILLA_AMERICAN_CUDA_SBKDSTPRCMP_XDOVLPUNROLL_SHUFFLE_TRIMOTM_DS
// #define DO_CARTESIAN_PRODUCT_OF_VANILLA_AMERICAN_CUDA_BKDSTPRCMP_XDOVLPUNROLL_SHUFFLE_TRIMOTM_DS
// #define DO_CARTESIAN_PRODUCT_OF_VANILLA_AMERICAN_CUDA_BATCH_SEARCH_BKDSTPRCMP_XDOVLPUNROLL_SHUFFLE_TRIMOTM_DS
#define DO_CARTESIAN_PRODUCT_OF_VANILLA_AMERICAN_CUDA_BATCH_BKDSTPRCMP_XDOVLPUNROLL_SHUFFLE_TRIMOTM_DS
// #define DO_CARTESIAN_PRODUCT_OF_VANILLA_AMERICAN_CUDA_BATCH_BKDSTPRCMP_XDOVLPUNROLL_SHUFFLE_TRIMOTM

#ifdef DO_CARTESIAN_PRODUCT
#define HYPERPARAMS_CART_PRODUCT(X, Y) CART_PROD_1(X, Y)

#define CART_PROD_1(X, Y)      \
    CART_PROD_2(D##64, 64, X, Y) \
    CART_PROD_2(D##256, 256, X, Y) \
    CART_PROD_2(D##128, 128, X, Y) \
    CART_PROD_2(D##512, 512, X, Y) \
    CART_PROD_2(D##1024, 1024, X, Y)

#define CART_PROD_2(ID, A, X, Y) \ 
    CART_PROD_3(ID,   A, 16,   X, Y) 
...
#define CART_PROD_3(ID, A, B, X, Y)   \
    CART_PROD_4(ID##32, A, B, 5, X, Y) 
    // CART_PROD_4(ID##64, A, B, 6, X, Y) \ 
    // CART_PROD_4(ID##128, A, B, 7, X, Y) \ 
    // CART_PROD_4(ID##256, A, B, 8, X, Y) \ 
    // CART_PROD_4(ID##512, A, B, 9, X, Y) \ 
    // CART_PROD_4(ID##1024, A, B, 10, X, Y) \ 
    // CART_PROD_4(ID##2048, A, B, 11, X, Y) \
    // CART_PROD_4(ID##4096, A, B, 12, X, Y) \
    // CART_PROD_4(ID##8192, A, B, 13, X, Y) \
    // CART_PROD_4(ID##16384, A, B, 14, X, Y) \
    // CART_PROD_4(ID##32768, A, B, 15, X, Y) \
    // CART_PROD_4(ID##65536, A, B, 16, X, Y) \
    // CART_PROD_4(ID##131072, A, B, 17, X, Y) \
    // CART_PROD_4(ID##262144, A, B, 18, X, Y) \
    // CART_PROD_4(ID##524288, A, B, 19, X, Y) \
