...
./build/bin/pricing_cli benchmark --filter-by-name shuffle --parameters xl-crazy --reference-function vanilla_american_binomial_cuda_bkdstprcmp_xdovlpunroll_vtile_trimotm --output-format=json