...
__global__ void fill_pricing_x_y_unroll(double* __restrict__ buffer, const double S, const double K,
...
__global__ void first_layer_kernel_x_y_unroll(double* d_option_values,
...
__global__ void single_vanilla_american_binomial_cuda_kernel_x_y_unroll(
...
double vanilla_american_binomial_cuda_x_y_unroll(const double S, const double K, const double T,
    ...
    fill_pricing_x_y_unroll<<<fill_num_blocks, 1024>>>(st_buffer, S, K, u, sign, n);
...
template double vanilla_american_binomial_cuda_x_y_unroll<DEFAULT_HYPERPARAMS_CUDA_XY_UNROLL>(
    ...
    #define PRODUCE_INSTANCES_OF_VANILLA_AMERICAN_CUDA_X_Y_UNROLL(ID, A, B, C, D, E, Y) template double vanilla_american_binomial_cuda_x_y_unroll<GRID_SEARCH_HYPERPARAMS_##ID>(const double S, const double K, const double T, const double r, const double sigma, const double q, const int n, const OptionType type);
    APPLY_FUNCTION(PRODUCE_INSTANCES_OF_VANILLA_AMERICAN_CUDA_X_Y_UNROLL, HYPERPARAMS_CART_PRODUCT, NULL)
