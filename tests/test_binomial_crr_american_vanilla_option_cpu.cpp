...
TEST_CASE("American Option Put-Call Parity Approximation", "[ame_put_call_parity]") {
    ...
    double putPrice = binomial_crr_american_vanilla_option_cpu(S, K, T, r, sigma, q, n, OptionType::Put);
    double callPrice = binomial_crr_american_vanilla_option_cpu(S, K, T, r, sigma, q, n, OptionType::Call);
...
TEST_CASE("American Option Linear Homogeneity", "[ame_linear_hom]") {
    ...
    double callPrice = binomial_crr_american_vanilla_option_cpu(S, K, T, r, sigma, q, n, OptionType::Call);
    double callPriceS = binomial_crr_american_vanilla_option_cpu(alpha*S, alpha*K, T, r, sigma, q, n, OptionType::Call);
