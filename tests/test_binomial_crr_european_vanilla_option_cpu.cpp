...
TEST_CASE("European Option Put-Call Parity Approximation", "[eur_put_call_parity]") {
  ...
  double putPrice =
      binomial_crr_european_vanilla_option_cpu(S, K, T, r, sigma, q, n, OptionType::Put);
  double callPrice =
      binomial_crr_european_vanilla_option_cpu(S, K, T, r, sigma, q, n, OptionType::Call);
...
TEST_CASE("European Option Linear Homogeneity", "[eur_linear_hom]") {
  ...
  double callPrice =
      binomial_crr_european_vanilla_option_cpu(S, K, T, r, sigma, q, n, OptionType::Call);
  double callPriceS = binomial_crr_european_vanilla_option_cpu(alpha * S, alpha * K, T, r, sigma, q,
                                                               n, OptionType::Call);
